...
Table: Roles, primary concerns, and features provided by `rstest‑bdd`.
...
Table: `scenario` macro arguments and their implementation status.
...
The generated tests can be filtered or executed in parallel.
...
Table: `rstest-bdd-lsp` environment variable configuration.
